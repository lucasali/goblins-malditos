 ...
 */
export const rollDice = (dice: number[]): number[] => {
 ...
 */
export const calculateTotal = (results: number[]): number => {
 ...
 */
export const formatDiceNotation = (count: number, faces: number): string => {
 ...
 */
export const parseDiceNotation = (notation: string): { count: number, faces: number } | null => {
